          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gray-50 border-b border-gray-200">
              <div className="grid grid-cols-3">
                <div className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900">School Statistics</h4>
                </div>
                {selectedSchools.map((school) => (
                  <div key={`stats-${school.id}`} className="p-6 border-l border-gray-200">
                    <div className="space-y-3">
                      <div className="text-center">
                        <div className="text-2xl font-bold text-[#257B5A]">{school.stats.totalStudents}</div>
                        <div className="text-sm text-gray-600">Total Students</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{school.stats.teacherRatio}</div>
                        <div className="text-sm text-gray-600">Teacher Ratio</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{school.stats.establishedYear}</div>
                        <div className="text-sm text-gray-600">Established</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-semibold text-gray-900">{school.stats.campusSize}</div>
