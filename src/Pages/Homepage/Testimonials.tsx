...
const Testimonials = () => {
  ...
  return (
    <section className="w-full bg-[#F7F1EE] py-14 sm:py-20">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-8 xl:px-[250px]">
        <div className="text-center">
          <h2 className="text-[28px] sm:text-[36px] md:text-[42px] lg:text-[48px] font-medium text-gray-900">
            Testimonials
          </h2>
        ...
        <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-8">
          ...
          <button
            ...
            className="rounded-md border border-black p-2.5 hover:bg-gray-200/50 transition"
          >
          ...
          {/* Testimonial Card */}
          <div className="w-full max-w-[800px] flex flex-col items-center rounded-xl border border-gray-300 px-4 py-8 sm:px-10 sm:py-10 bg-white">
